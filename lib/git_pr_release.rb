#!/usr/bin/env ruby
# -*- coding: utf-8 -*-
# fork from https://github.com/motemen/git-pr-release
...
module GitPrRelease
  ...
  production_branches  = git_config('branch.production').split(/\s*,\s*/) || ['master']
  ...
  production_branches.each do |production_branch|
